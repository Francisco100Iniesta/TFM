...
chrs = c(
  ...
  "CP068255.2",
  "CP086569.2"
) # Human chromosomes used to filter out Unknown and Random fragments
...
genes = annotatedInsertionsMin3[SUPP_trusty > 0 & SUPP_geno > 0 & annot.subclass %in% c("cds", "introns", "promoters") & !is.na(annot.symbol), 
                .SD[1], 
